  ...
  while true; do
    ...
    case $choice in
      1)
        ...
        # 下载脚本
        curl -L https://raw.githubusercontent.com/ShuQinYu/aztec/refs/heads/main/aztec_node.sh -o /root/aztec_node.sh
        sleep 1
      ...
      4)
        ...
        # 下载脚本
        curl -L https://raw.githubusercontent.com/ShuQinYu/aztec/refs/heads/main/aztec_prover.sh -o /root/aztec_prover.sh
        sleep 1
